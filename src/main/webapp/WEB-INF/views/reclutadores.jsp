            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="text-left">
                        ...
                        Registro |
                        <a href="${pageContext.request.contextPath}/reclutadores/ofertas">Ofertar</a> |
                ...
                <div class="col-12">
                    <form:form method="post" modelAttribute="reclutador">
                        <form:hidden path="id" />

                        <div class="form-group">
                            <form:label path="nombreFantasia">Nombre de Fantasia</form:label>
                            <form:input path="nombreFantasia" cssClass="form-control" cssErrorClass="form-control is-invalid" />
                            <form:errors path="nombreFantasia" cssClass="invalid-feedback" />
                        </div>

                        <div class="form-group">
                            <form:label path="razonSocial">Razón Social</form:label>
                            <form:input path="razonSocial" cssClass="form-control" cssErrorClass="form-control is-invalid" />
                            <form:errors path="razonSocial" cssClass="invalid-feedback" />
                        </div>
